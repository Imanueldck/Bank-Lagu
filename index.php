...
<div class="container mt-4">
    <div class="row">
        ...
        $query = "SELECT * FROM lagu WHERE judul LIKE '%$cari%' LIMIT $offset, $perPage";
    ...
    <div class="container text-center">
        <div class="row">
            <div class="col-md-4 mb-3">
                <h5>Bank Lagu</h5>
                <p>Deskripsi dari bank lagu</p>
            </div>
            <div class="col-md-4 mb-3">
                <h5>Contact Us</h5>
                <p>Email: support@banklagu.com</p>
        ...
        <hr>
        <div class="pt-3">
            <p>&copy; 2025 Bank Lagu. All Rights Reserved.</p>
        </div>
    </div>
</footer>
